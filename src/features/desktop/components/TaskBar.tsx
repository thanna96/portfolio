...
export function TaskBar() {
    ...
    return (
        <>
            ...
            <div
                className="absolute bottom-0 flex w-full items-center justify-between px-1"
            ...
            >
                ...
                <div className="flex items-center gap-2 border-2 border-[#a4a4a4] px-3 shadow-inner">
                    <Image
